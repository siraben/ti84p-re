...
This standalone interactive visualization shows the TI-84 Plus OS 2.55MP
graphing paths documented in
[`docs/sub-graphing.md`](../../docs/sub-graphing.md). The page is deployed
beside the wiki at `/graphing/`, outside mdBook.
...
The page separates ROM-confirmed structure from browser arithmetic.
