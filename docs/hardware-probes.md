...
Run these probes through the ordinary TI-OS `Asm(` launcher in independent
mapping mode. In paired mapper mode, a port-`0x06` write can remap the running probe.
...
Older artifacts used port-`0x04` bit 0 as a guard. Their outcome 4 is a legacy
rejection, not mapping evidence; identify the artifact before interpreting it.
...
The pinned SPASM-ng build produces 854 machine-code bytes with SHA-256
`ae6ec736a52f9c06271184afb03d6adfb1740a9872c07d0c6591ea0144987e66`.
The packaged 1,788-byte `HWBATT.8xp` has SHA-256
`f2a755b8e98575e6cf0a9b7585a8ea61fda9f7dcb613030c48cfa8972f432bb5`.
[confirmed]
...
| `tools/ti84re/hardware/compact_probe_code.py` | reversible compact text encoder and decoder for complete `HWP1` frames |
