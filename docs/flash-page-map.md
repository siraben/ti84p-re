...
The large-font glyph table is on page `0x07` (see [Display and LCD](display-lcd.md#large-font-text)). Alternate large fonts live on pages `0x01` and `0x36` (selected by `IY+0x35` bits 5 and 1). Page `0x07` also holds archive code, list and matrix code, and error messages. [confirmed]
