...
| `55/56` | usbIntStatus/usbLineEvents | USB interrupt state / line events (84+) — polled first in `int_dispatch_sources` (older notes: `isr_im1`; read-only; **not** a status/mask pair) |
