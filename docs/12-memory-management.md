...
Flash is written/erased a sector at a time via low-level routines through the **flash-control port `0x14`**. These are now located (see [Variables, Archive & Unarchive](sub-vat-archive.md)) **[confirmed via subagent RE]**:
