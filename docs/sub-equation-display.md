...
destinations, overlays exact next-PC outcomes from 197 reset-origin traces, and
...
traces, 196 reach their state through calculator input. One explicitly
...
None of the 197 report traces executes `39:5167`, `39:523B`, the saved-operand
wrappers at `39:5B10`–`39:5B38`, or the dispatchers at `39:59E0`/`39:59F9`.
The 197-digest trace cache also has no hit at those entries. [confirmed]
...
independent oracle case. Its all-evidence universe has 1,277 tags and needs 135
traces. The natural-only universe has 1,274 tags and needs 134 traces. Every
...
source in the 197-trace report. It supplies the only evidence for
