...
destinations, overlays exact next-PC outcomes from 203 reset-origin traces, and
...
traces, 202 reach their state through calculator input. One explicitly
...
None of the 203 report traces executes `39:5167`, `39:523B`, the saved-operand
wrappers at `39:5B10`–`39:5B38`, or the dispatchers at `39:59E0`/`39:59F9`.
The 203-digest trace cache also has no hit at those entries. [confirmed]
...
independent oracle case. Its all-evidence universe has 1,283 tags and needs 141
traces. The natural-only universe has 1,280 tags and needs 140 traces. Every
...
source in the 203-trace report. It supplies the only evidence for
...
oracles for every cursor class. Deeper nested positions, other structural
template types, structural deletion, and structural-boundary navigation remain
open. [confirmed]
