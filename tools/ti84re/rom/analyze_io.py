...
from ti84re.rom.io import inline_descriptor_at
from ti84re.rom.z80_disassembly import DisassemblyError, disassemble_page
from ti84re.rom.z80_io import iter_resolved_io_accesses, parse_port_specs
...
def main() -> None:
    ...
    parser.add_argument(
        "--ports-file",
        type=Path,
        default=SYMBOLS / "ports.txt",
        help="project-local port labels (default: tools/symbols/ports.txt)",
    )
    parser.add_argument(
        "--page",
        action="append",
