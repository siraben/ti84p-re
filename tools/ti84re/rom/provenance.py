...
from ti84re.rom.bcall_tables import classify_boot_page
...
def build_manifest(
    ...
    *,
    ...
    return {
        ...
        "include": {
            "path": "tools/symbols/ti83plus.inc",
        ...
        "source_command": (
            "python3 -m ti84re.rom.provenance manifest"
...
def main() -> None:
    ...
    manifest.add_argument("--rom", type=Path, default=DEFAULT_ROM)
