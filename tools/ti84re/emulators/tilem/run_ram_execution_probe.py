...
from ti84re.hardware.execution_protection import (
    PAGE_SIZE,
    TI84P_BOOT_PROTECTION,
    tilem_ram_execution_allowed,
    wabbitemu_ram_execution_allowed,
)
from ti84re.hardware.execution_protection_fixture import (
    RamExecutionTarget,
...
from ti84re.emulators.probe_cli import emit_result, require_fresh_output_dir, write_json
from ti84re.paths import MACROS, PROBES, DEFAULT_ROM

SOURCE = PROBES / "emulator" / "execution-protection-ram-tilem.asm"
MACRO = MACROS / "run-first-program.macro"
DEFAULT_TARGETS = (
