...
Usage: python3 -m ti84re.mathprint.parity [name ...]   (default: all)
"""
import argparse
import json
import hashlib
...
from ti84re.mathprint.analyze_records import (
    decode_record_header,
    decode_settled_expression,
)
from ti84re.trace.hardware import count_resolved_trace_points, trace_header
...
def calc_from_trace(trace, *, preserve_internal_gaps=False, expected_size=None):
    ...
    from ti84re.trace import lcd as tl
        ...
        report = {
            ...
            "capture": {
                ...
                "reproduce": (
                    ...
                    "python3 -m ti84re.mathprint.parity integral integral_frac "
                    "--report tools/oracles/mathprint/mathprint-trace-report.json"
                ),
            },
            "scenarios": scenarios,
            "resolver_caution": (
