...
Usage: python3 -m ti84re.mathprint.export_font [--rom tools/rom.bin]
"""
import argparse
import hashlib
import json
...
from ti84re.paths import DEFAULT_ROM, WEB
...
def main():
    ...
    ap.add_argument("--json", default=str(WEB / "mathprint" / "font.json"))
    args = ap.parse_args()
