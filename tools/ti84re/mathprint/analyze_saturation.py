...
Run through the development shell so ``z80dasm`` is available::
    ...
    nix develop -c python3 -m ti84re.mathprint.analyze_saturation \
      --trace scalar=/tmp/mp-render-types-mku5nyij/scalar_2.trace \
      --output tools/oracles/mathprint/mathprint-saturation.json
...
from ti84re.trace.resolve import iter_records, read_header, resolve_instruction
...
from ti84re.paths import ROOT, ORACLES, DEFAULT_ROM


DEFAULT_OUTPUT = ORACLES / "mathprint/mathprint-saturation.json"
...
TRANSLATION_SURFACES = (
    {
        ...
        "tests": ["tools/js/test-mathprint.js"],
    ...
    },
    {
        ...
        "tests": ["tools/js/test-mathprint.js", "tools/mathprint-*-oracles.json"],
    ...
    },
    {
        ...
        "scope": (
            ...
            "prefixed radical, integral, nDeriv, summation, nth-root, log-base, and postfix-power insertion "
            "at every root cursor class, and the "
            ...
            "packed-token navigation, including bidirectional movement through every "
            "nested-list frame boundary of a token-built one-cell matrix; "
            ...
            "nDeriv and log-base, bidirectional traversal of a depth-two fraction "
            "whose empty-slot leaf is atomic, and bidirectional traversal of a fraction "
            "nested in a radical; a summation fill sequence covers "
            "type-01h post-insertion "
    ...
    },
    {
        ...
        "tests": [
            "tools/js/test-mathprint.js",
            "tools/oracles/mathprint/mathprint-editor-gap-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-mutation-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-structural-mutation-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-template-boundary-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-navigation-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-structural-navigation-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-extra-structural-navigation-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-summation-fill-oracle.json",
            "tools/oracles/mathprint/mathprint-editor-deletion-oracles.json",
            "tools/oracles/mathprint/mathprint-editor-structural-deletion-oracles.json",
        ],
        "scope": (
            ...
            "replacement; in-leaf packed-token navigation, including bidirectional "
            "movement through every nested-list frame boundary of a token-built "
            "one-cell matrix; "
            ...
            "nDeriv and log-base, bidirectional traversal of a depth-two fraction "
            "whose empty-slot leaf is atomic, and bidirectional traversal of a fraction "
            "nested in a radical; structural insertion returns a "
            "composable decoded arena, "
    ...
    },
    {
        ...
        "tests": ["tools/js/test-mathprint.js", "tools/tests/mathprint/test_mathprint_draw_trace.py"],
        "scope": (
    ...
    },
    {
        ...
        "tests": [
            "tools/js/test-mathprint.js",
            "tools/oracles/mathprint/mathprint-nested-baseline-oracles.json",
        ],
        "scope": (
    ...
    },
    {
        ...
        "tests": ["tools/js/test-mathprint.js", "tools/tests/mathprint/test_mathprint_saturation.py"],
        "scope": (
    ...
    return [
        ...
        },
        {
            ...
            "reason": (
                ...
                "radicand of one prefixed radical, integral, nDeriv, summation, nth-root, log-base, and "
                "postfix-power insertion at every root cursor class, and the shared "
                "one-child path for absolute "
                ...
                "in-leaf packed-token navigation, including bidirectional movement through "
                "every nested-list frame boundary of a token-built one-cell matrix, and "
                "packed-token deletion with empty-slot "
                ...
                "case verifies nested empty-slot restoration; live root-level structural "
                "boundary traversal covers every insertable type 20h–2Ah and includes "
                "bidirectional depth-two fraction traversal, a fraction nested in a "
                "radical in both directions, and atomic type-01h and EF1Eh leaves; "
                "structural "
                "insertion returns a composable "
                ...
                "nested traversal states and matrix deletion remain open"
            ),
        },
        {
...
def build_report(
    ...
    report = {
        ...
        "method": {
            ...
            "symbolic_detail_storage": (
                "regenerated by symbolic_model_corpus(); the checked report "
                "retains aggregate counts"
            ),
            "computed_dispatches": {
                "manually_seeded": [
