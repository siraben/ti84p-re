...
Usage:
    python3 -m ti84re.mathprint.render                 # built-in layout examples
    python3 -m ti84re.mathprint.render --font-index     # every codepoint + glyph
    python3 -m ti84re.mathprint.render --rom PATH        # use a specific ROM image
