...
from ti84re.hardware.debug import MemoryExpectation, MemoryMismatch, check_memory_expectation
from ti84re.paths import ROOT, TOOLS, SYMBOLS, MACROS, DEFAULT_ROM


SAMPLES = TOOLS / "tibasic-samples"
DEFAULT_MACRO = MACROS / "run-first-program.macro"
...
def generate_loadvar_macro(dest: Path, programs: tuple[str, ...], exec_lines: tuple[str, ...] = ()) -> Path:
    ...
    lines = [
        "# Generated by ti84re.tibasic.smoke: load fixtures via LINK->RECEIVE",
