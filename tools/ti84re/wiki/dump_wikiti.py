...
Usage:
    python3 -m ti84re.wiki.dump_wikiti            # dump default namespaces
    python3 -m ti84re.wiki.dump_wikiti --all-ns   # include talk/user namespaces too
    python3 -m ti84re.wiki.dump_wikiti --images    # also download uploaded files
