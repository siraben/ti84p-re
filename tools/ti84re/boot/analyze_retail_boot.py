...
from ti84re.rom.bcall_tables import BOOT_TABLE_ID_RANGES, read_boot_names
from ti84re.trace.hardware import ResolvedInstruction, iter_resolved_instructions
...
def build_report(
    ...
    *,
    ...
    public_names = read_boot_names(SYMBOLS / "ti83plus.inc")
    unnamed_entries = []
    for first, last in BOOT_TABLE_ID_RANGES:
        for identifier in range(first, last + 1, 3):
