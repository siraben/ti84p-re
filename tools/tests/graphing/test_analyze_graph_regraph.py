...
from ti84re.graphing.analyze_regraph import analyze_trace, summarize_sequence
from ti84re.trace.resolve import HEADER_FMT, INSTR_FMT, MAGIC
from ti84re.paths import ORACLES, MACROS


REPORT = ORACLES / "graphing/graph-regraph.json"
