...
from ti84re.rom.port_definitions import load_port_definitions
from ti84re.rom.image import RomImage
from ti84re.rom.io_coverage import (
...
class RomIOCoverageTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.definitions = load_port_definitions(SYMBOLS / "ports.txt")
