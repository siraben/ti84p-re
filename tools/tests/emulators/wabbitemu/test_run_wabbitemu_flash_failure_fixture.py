...
from ti84re.emulators.wabbitemu.run_flash_failure_fixture import validate_probe_inputs
...
class WabbitemuFlashFailureCliTests(unittest.TestCase):
    ...
    def test_rejects_arbitrary_adapter(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                patch("ti84re.emulators.probe_cli.TI84_PLUS_OS_255MP_SHA256", rom_hash),
