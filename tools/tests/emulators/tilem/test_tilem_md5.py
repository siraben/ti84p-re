...
from ti84re.emulators.tilem.md5 import (
    TilemMd5Error,
    TilemMd5Report,
    build_command,
    expected_md5_report,
...
class TilemMd5ReportTests(unittest.TestCase):
    ...
    @patch("ti84re.emulators.tilem.md5.build_core_command", return_value=["cc", "probe"])
    def test_build_command_adds_shared_support(self, build_core):
        command = build_command(
            Path("/tmp/tilem"),
            Path("tools/probes/tilem/tilem_md5_probe.c"),
