...
from ti84re.emulators.tilem.battery import (
    TilemBatteryError,
    TilemBatteryReport,
    build_command,
...
class TilemBatteryReportTests(unittest.TestCase):
    ...
    @patch("ti84re.emulators.tilem.battery.build_core_command", return_value=["cc", "probe"])
    def test_build_command_adds_shared_support(self, build_core):
        command = build_command(
            Path("/tmp/tilem"),
            Path("tools/probes/tilem/tilem_battery_probe.c"),
