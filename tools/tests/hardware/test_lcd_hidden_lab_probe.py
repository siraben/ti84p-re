...
from ti84re.hardware.build_lcd_hidden_lab_probe import (
    ACK_TEXT,
    APPVAR,
    PAYLOAD_SIZE,
    PROGRAM,
...
from ti84re.hardware.run_lcd_hidden_lab_emulator import validate_capture
from ti84re.tibasic.samples import T
...
class LcdHiddenLabProbeTests(unittest.TestCase):
    ...
    def test_tracked_emulator_record_matches_both_asic_specific_images(self):
        record = json.loads(
            (ORACLES / "hardware" / "lcd-hidden-lab-emulators.json")
    ...
    def test_exact_capture_requires_matching_appvar_and_decimal_code(self):
        ...
        from ti84re.hardware.probe import probe_verification_code
