...
from ti84re.hardware.mapper_probe_evidence import (
    load_json,
    normalize_exact_run,
...
FIXTURE = ORACLES / "hardware" / "mapper-overlays-emulators.json"
...
class MapperProbeEvidenceTests(unittest.TestCase):
    ...
    def test_freshness_check_rejects_source_drift(self):
        ...
        changed["sources"]["tools/probes/hardware/mapper-overlays.asm"] = "0" * 64
