#!/usr/bin/env python3
"""Regression tests for the guarded retail USB-ROM probe CLI."""
...
from run_wabbitemu_usb_rom_probe import validate_probe_inputs


class WabbitemuUsbRomCliTests(unittest.TestCase):
    def test_accepts_exact_rom_and_adapter_hashes(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "probe_cli.TI84_PLUS_OS_255MP_SHA256",
                rom_hash,
            ):
