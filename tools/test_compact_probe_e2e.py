...
import run_compact_probe_e2e as compact_e2e
from run_compact_probe_e2e import ROOT, run_backend, validate_evidence

FIXTURE = ROOT / "tools" / "fixtures" / "compact-probe-e2e.json"
LINK_FIXTURE = ROOT / "tools" / "fixtures" / "compact-probe-link-e2e.json"
