...
from rom_io_coverage import audit_indirect_io, audit_unlisted_io
from z80_disassembly import DisassemblyError
...
def main() -> None:
    ...
    parser.add_argument("--ports-file", type=Path, default=TOOLS / "ports.txt")
