...
from interrupt_controller import TilemLegacyInterruptState
from tilem_interrupt import (
    MASK_VALUES,
    TilemInterruptError,
...
class TilemInterruptReportTests(unittest.TestCase):
    ...
    @patch("tilem_interrupt.build_core_command", return_value=["cc", "probe"])
    def test_build_command_adds_shared_support(self, build_core):
        command = build_command(
            Path("/tmp/tilem"),
            Path("tools/tilem_interrupt_probe.c"),
