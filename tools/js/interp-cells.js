...
// the browser. See tools/notes/cell-glyph-spec.md and tools/notes/token-name-spec.md.
//
// Usage: node tools/js/interp-cells.js [classHex]   (default 08 = fnInt/nDeriv row)
