...
//
// Usage: node tools/js/test-mathprint.js [count]   (default 5000)

const fs = require('fs');
const path = require('path');
const crypto = require('crypto');

const root = path.dirname(path.dirname(__dirname));  // repository root
const mp = require(path.join(root, 'web', 'mathprint', 'app.js'));
const rom = require(path.join(root, 'web', 'mathprint', 'rom-engine.js'));
const { resolveCell } = require('./interp-cells.js');
...
const constructionOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-construction-oracles.json')));
const exponentialLogBaseOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-exponential-logbase-oracles.json')));
const nestedBaselineOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-nested-baseline-oracles.json')));
const matrixOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-matrix-oracles.json')));
const matrixBaselineOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-matrix-baseline-oracles.json')));
const liveEditorOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-live-editor-oracles.json')));
const editorGapOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-editor-gap-oracles.json')));
const editorMutationOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-editor-mutation-oracles.json')));
const editorStructuralMutationOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint',
...
const editorNavigationOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-editor-navigation-oracles.json')));
...
const editorDeletionOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-editor-deletion-oracles.json')));
...
const groupingOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-grouping-oracles.json')));
const structuralBaseOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-structural-base-oracles.json')));
const namedTokenOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-named-token-oracles.json')));
const twoByteTokenOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-two-byte-token-oracles.json')));
const editorOverflowOracle = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-editor-overflow-oracle.json')));
const radicalViewportOracle = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-radical-viewport-oracles.json'))).cases[0];
const listOracles = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-list-oracles.json')));
const verticalViewportOracle = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-vertical-viewport-oracle.json'))).cases[0];
const combinedViewportOracle = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-combined-viewport-oracle.json')));
const yEquSelectionOracle = JSON.parse(fs.readFileSync(
  path.join(root, 'tools', 'oracles', 'mathprint', 'mathprint-yequ-selection-oracle.json')));
