...
from build_hardware_probes import PROBES, assemble_machine_code
from compact_probe_code import decode_compact_probe_code, encode_compact_probe_code
from file_hashes import file_sha256
from hardware_probe import decode_probe_frame, probe_verification_code
from probe_cli import DEFAULT_ROM, require_exact_hash
...
SOURCE_PATHS = (
    ...
    "tools/compact_probe_code.py",
    "tools/hardware_probe.py",
    "tools/build_hardware_probes.py",
    "tools/emulator_probe_build.py",
    "tools/build_tilem_compact_probe.py",
    "tools/build_wabbitemu_compact_probe.py",
    "tools/tilem_compact_probe.c",
    "tools/tilem_probe_support.c",
    "tools/tilem_probe_support.h",
    "tools/tilem_core.py",
    "tools/wabbitemu_compact_probe.cpp",
    "tools/wabbitemu_headless.cpp",
    "tools/wabbitemu_headless.py",
    "tools/run_compact_probe_e2e.py",
)
...
def source_hashes(probe_name: str, root: Path = ROOT) -> dict[str, str]:
    ...
    paths = (*SOURCE_PATHS, f"tools/hardware-probes/{PROBES[probe_name].source_name}")
