...
by `tools/ti84re/rom/signatures.py`. Unless marked otherwise, byte, table, and control-
...
(see `tools/ti84re/mathprint/render.py`).
...
- `39:6B66`: `D ≠ 0xFB` falls to `39:6B9C`, whose complete bytes are
  ...
  branch-specific index arithmetic is documented in `tools/notes/token-name-spec.md`.
