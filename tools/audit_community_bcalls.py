...
def main() -> int:
    ...
    parser.add_argument("--main-map", type=Path, default=Path("tools/bcalls.txt"))
    parser.add_argument(
        "--boot-map", type=Path, default=Path("tools/bcalls8x_targets.txt")
    )
    parser.add_argument("--include", type=Path, default=Path("tools/ti83plus.inc"))
